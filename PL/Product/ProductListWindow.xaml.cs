...
namespace PL
{
    ...
    public partial class ProductListWindow : Window
    {
        ...
        {
            InitializeComponent();
            ProductListView.DataContext = bl.Product.GetList(); // that in the beginning it will be initialized
        ...
        private void SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            ProductListView.DataContext = (bl ?? BlApi.Factory.Get()).Product.GetList(func); // get A list with all the products that answer the deserve condition
        }
